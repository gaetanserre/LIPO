...
python main.py --function="-(100 * (x[1] - x[0]**2)**2 + (1 - x[0])**2)" -n 2000 -b="-3 3 -3 3" -k 14607 --name "rosenbrock" && \
python main.py --function="-np.sqrt( (x[0] - np.pi / 16)**2 + (x[1]-np.pi/16)**2 )" -n 100 -b="0 1 0 1" -k 1.5 --name "sphere" && \
python main.py --function="-(x[0]**2 + x[1]**2)" -n 500 -b="-10 10 -10 10" -k 20 --name "square"